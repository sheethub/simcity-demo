var _, initMap, trafficLayer, terrainMap, hybridMap, darkMap, styleOption, setMapStyle, pinkMap, darkMapBuildingStroke, withPOI, withTransport, redSchool, greenPark, comicsMap, local_road, blueWater, man_made, greenLandscape, high_tech, removeLabel, removeStroke, removeFill, nullStyle, map, presentation, i, next, prev;
_ = require("prelude-ls");
initMap = function(){
  var TaipeiLatLng, mapOptions, map;
...
darkMap = function(){
  return map.setMapTypeId('darkMap');
};
styleOption = {
  "pinkMap": [{
    "featureType": "all",
...
setMapStyle = function(styleList){
  return function(it){
...
nullStyle = ["nullStyle"];
map = initMap();
presentation = [nullStyle, pinkMap, removeLabel, removeFill, removeStroke, greenLandscape, blueWater, greenPark, man_made, local_road, darkMapBuildingStroke, high_tech, redSchool, withTransport];
i = -1;
next = function(){
  ++i;
